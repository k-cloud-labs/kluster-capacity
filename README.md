...
$ ./kluster-capacity ce --kubeconfig <path to kubeconfig> --pods-from-template <path to pod templates> 
...
```sh
$ ./kluster-capacity ce --kubeconfig <path to kubeconfig> --pods-from-template <path to pod templates> --verbose
Pod requirements:
	- cpu: 150m
	- memory: 100Mi
...
```sh
$ ./kluster-capacity ce --kubeconfig <path to kubeconfig> --pods-from-template <path to pod templates> -o json
$ ./kluster-capacity ce --kubeconfig <path to kubeconfig> --pods-from-template <path to pod templates> -o yaml
```
